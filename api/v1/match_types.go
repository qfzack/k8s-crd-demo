...
// MatchSpec defines the desired state of Match
...
// Match is the Schema for the matches API
type Match struct {
...
// MatchList contains a list of Match
...
func init() {
	SchemeBuilder.Register(&Match{}, &MatchList{})
}
